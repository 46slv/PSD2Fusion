...
- Closure PASS only with: every material-scale difference resolved or explicitly supported/rejected per capability policy, remainder is acceptance-non-blocking quantization class, strict-0 diagnostic retained, float32 preserved, no fitting nodes.
